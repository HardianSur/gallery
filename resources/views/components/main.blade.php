...
<body class="bg-slate-50 dark:bg-gray-900">
    ...
    <footer
        ...
        <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
            &copy; {{ now()->year }} <a href="3" class="hover:underline" target="_blank">Hardian Gallery</a>.
            All
            rights reserved.
        </p>
        <div class="flex justify-center items-center space-x-1">
            ...
            <a href="https://github.com/HardianSur" target="blank" data-tooltip-target="tooltip-github"
                class="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
                <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
