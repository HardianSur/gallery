...
@section('container')
    <div class="py-8 px-4 mx-auto max-w-full lg:py-16 lg:px-4 border-white">
        <section class="flex justify-center items-center gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            ...
            <div class="w-11/12 p-6 flex flex-col items-center justify-center"> <!-- Tambahkan flex-col -->
                <div class="mb-0">
                    <a href="#">
                ...
                <div class="mt-1">
                    <h1 class="text-3xl font-bold">Zuck</h1>
                </div>
                <div class="mt-3">
                    <h3 class="flex items-center gap-2">
                        ...
                        <span class="font-medium">Zuck321</span>
                    </h3>
                </div>
                <div class="mt-2">
                    <button
        ...
        <section id="buttonContainer" class="flex justify-center gap-2 mb-11">
            <button
                class="w-fit px-2 py-2 text-slate-600 hover:text-black  hover:border-b-2 hover:border-black font-medium text-xl ">Foto</button>
            <button
                class="w-fit px-2 py-2 text-slate-600 hover:text-black  hover:border-b-2 hover:border-black font-medium text-xl ">Album</button>
        </section>
