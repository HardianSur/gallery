...
<section class="container mx-auto p-10 md:p-20 antialiased ">
    <article class=" flex flex-wrap md:flex-nowrap shadow-lg mx-auto max-w-7xl group cursor-pointer transform duration-500 hover:-translate-y-1">
        <img class="w-full h-auto object-cover md:w-52" src="https://i.ibb.co/Kr4b0zJ/152013403-10158311889099633-8423107287930246533-o.jpg" alt="">
        <div class="">
            <div class="p-5 pb-10">
