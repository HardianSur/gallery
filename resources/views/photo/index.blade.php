                    ...
                    <div class="max-w-2xl mx-auto px-4">
                      ...
                      <div class="space-y-4 p-4 max-h-96 overflow-y-auto pr-2 bg-slate-200" id="comment-section">
                        ...
                        <div class="p-4 bg-gray-50 rounded-lg">
                          ...
                          <!-- Reply Button -->
                          <button class="mt-2 text-sm text-blue-500 hover:underline" onclick="replyTo('John Doe')">Reply</button>
                          <div id="replyInput" class="hidden mt-4">
                            ...
                            ></textarea>
                            <button class="mt-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600" >Post Reply</button>
                          </div>
                          ...
                          <div class="mt-4 pl-4 border-l-2 border-gray-200 space-y-2">
                            <div class="p-3 bg-gray-100 rounded-lg">
                              ...
                              <button class="mt-2 text-sm text-blue-500 hover:underline" onclick="replyTo('Jane Smith')">Reply</button>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="p-4 bg-gray-50 rounded-lg">
                          ...
                          <button class="mt-2 text-sm text-blue-500 hover:underline" onclick="replyTo('Alice Johnson')">Reply</button>
                        </div>
